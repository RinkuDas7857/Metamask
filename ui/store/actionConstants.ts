...
export const IMPORT_TOKENS_EXIT_POPOVER_OPEN =
  'IMPORT_TOKENS_EXIT_POPOVER_OPEN';
export const IMPORT_TOKENS_EXIT_POPOVER_CLOSE =
  'IMPORT_TOKENS_EXIT_POPOVER_CLOSE';
